...
"""),_display_(/*3.2*/main(null)/*3.12*/ {_display_(Seq[Any](format.raw/*3.14*/("""
	...
	<section id="profileMain">
		<form class="formoid-solid-dark"
			...
			<div class="submit">
				<a href="javascript:deleteProfile('"""),_display_(/*306.41*/profile/*306.48*/.name),format.raw/*306.53*/("""')" class="buttonDelete" style="color: #FFFFFF;">Delete</a>
			</div>
			<div class="modifiedSection">
				<table class="modifiedTable">
					<tr>
						<td>Modified By:</td>
						<td>"""),_display_(/*312.12*/profile/*312.19*/.updatedBy),format.raw/*312.29*/("""</td>
					</tr>
					<tr>
						<td>Last Modified:</td>
						<td>"""),_display_(/*316.12*/profile/*316.19*/.dateUpdated),format.raw/*316.31*/("""</td>
					</tr>
				</table>
			</div>
