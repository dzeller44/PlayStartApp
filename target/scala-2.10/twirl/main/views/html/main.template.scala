								...
								<ul>
									...
									<li class="scroll_btn"><a href="/signup">Register</a></li>
  									...
  									""")))}/*102.14*/else/*102.19*/{_display_(Seq[Any](format.raw/*102.20*/("""  										
  										"""),format.raw/*103.13*/("""<li class="scroll_btn"><a href="/useraccount?email="""),_display_(/*103.65*/currentEmail),format.raw/*103.77*/("""">"""),_display_(/*103.80*/currentEmail),format.raw/*103.92*/("""</a></li>
