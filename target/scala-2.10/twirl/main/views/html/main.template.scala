							...
							<nav class="navmenu center">
								<ul>
									...
									<li class="scroll_btn"><a href="/signup">Register</a></li>
  									...
  									"""),_display_(/*100.13*/if(currentEmail == "")/*100.35*/ {_display_(Seq[Any](format.raw/*100.37*/("""
  										"""),format.raw/*101.13*/("""<li class="scroll_btn"><a href="/auth">Login</a></li>
  									""")))}/*102.14*/else/*102.19*/{_display_(Seq[Any](format.raw/*102.20*/("""  										
  										"""),format.raw/*103.13*/("""<li class="scroll_btn"><a href="/useraccount?email="""),_display_(/*103.65*/currentEmail),format.raw/*103.77*/("""" style="text-transform: lowercase;">"""),_display_(/*103.115*/currentEmail),format.raw/*103.127*/("""</a></li>
