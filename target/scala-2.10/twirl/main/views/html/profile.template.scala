		...
		<div class="element-checkbox">
			...
			<div class="column column1">
				<label><input type="checkbox"
					...
					value="waterbottled" required="required"><span>Water
				Bottled</span></label> <label><input type="checkbox" name="services"
					value="waterbulk" required="required"><span>Water
				Bulk</span></label> <label><input type="checkbox" name="services"
					value="sanitation" required="required"><span>Sanitation/Toilet/Sink</span></label>
				<label><input type="checkbox" name="services"
					value="dumpster"required="required"><span>Dumpsters</span></label>
				<label><input type="checkbox" name="services"
					value="shower" required="required"><span>Showers</span></label> <label><input
					type="checkbox" name="services" value="generator" required="required"><span>Generators</span></label> <label><input
					type="checkbox" name="services" value="pump"
					required="required"><span>Pumps</span></label> <label><input
					type="checkbox" name="services" value="heavyequip"
					required="required"><span>Heavy Equipment</span></label> <label><input
					type="checkbox" name="services" value="fuel"
					required="required"><span>Fuel</span></label> <label><input
					type="checkbox" name="services" value="sandbags"
					required="required"><span>Sandbags</span></label> <label><input
					type="checkbox" name="services" value="tempfacility"
					required="required"><span>Temporary Facilities</span></label> <label><input
					type="checkbox" name="services" value="profserv"
					required="required"><span>Professional Services</span></label> <label><input
					type="checkbox" name="services" value="other"
					required="required"><span>Other (Please List)</span></label>
			</div>
			<div id="otherService" class="element-input">
				<label class="title"><span class="required">*</span>Other:</label>
				<div class="item-cont">
					<input class="large" type="text" name="serviceOther" required="required"
...
object profile extends profile_Scope0.profile
              /*
                  -- GENERATED --
                  DATE: Mon Nov 07 12:17:04 MST 2016
                  SOURCE: C:/WebDev/git/PlayAuthenticate/app/views/profile.scala.html
                  HASH: 88ca7a96a5f1bf7adc5b5c9174d3750f51000c61
                  MATRIX: 776->1|919->49|947->52|965->62|1004->64|1031->65|12813->11819|12842->11820|12872->11822|12901->11823|14122->13016|14151->13017|14181->13019|14210->13020|16971->15754|17012->15785|17053->15787|17093->15798|17195->15872|17216->15883|17258->15903|17298->15914|17344->15929|17375->15932|17513->16042|17553->16060
